...
import com.meowapp.meowapp.error.ApiError;
import com.meowapp.meowapp.shared.GenericResponse;
import com.meowapp.meowapp.user.User;
import com.meowapp.meowapp.user.UserRepository;
...
public class UserControllerTest {
	...
	@Test
	public void postUser_whenUserHasNullPasswordExceedsTheLengthLimit_receiveBadRequest() {
		User user = createValidUser();
		String valueOf256Chars = IntStream.rangeClosed(1,256).mapToObj(x -> "a").collect(Collectors.joining());
	...
	@Test
	public void postUser_whenUserHasNullPasswordAllLowercase_receiveBadRequest() {
		User user = createValidUser();
	...
	@Test
	public void postUser_whenUserHasNullPasswordAllUppercase_receiveBadRequest() {
		User user = createValidUser();
	...
	@Test
	public void postUser_whenUserHasNullPasswordAllNumber_receiveBadRequest() {
		User user = createValidUser();
	...
	@Test
	public void postUser_whenUserIsValid_receiveApiErrorWithValidationError() {
		User user = new User();
		ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
	...
	@Test
	public void postUser_whenUserInvalidPasswordPattern_receiveGenericMessageofSizeError() {
		User user = createValidUser();
